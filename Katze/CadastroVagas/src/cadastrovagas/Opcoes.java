...
public class Opcoes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Buscar no Banco de Dados");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.p.escolherCadastro();
         this.setVisible(false);
         JOptionPane.showMessageDialog(null, "Opção, cadastro selecionado.");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.p.escolherBusca();
        this.setVisible(false);
        JOptionPane.showMessageDialog(null, "Opção, gerar tabela selecionado.");
